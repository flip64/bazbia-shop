...
urlpatterns = [
    ...
    path("accounts/", include(("core.urls", "core"), namespace="core")),
    path("orders/", include(("orders.urls", "orders"), namespace="orders")),
    path("dashboard/", include(("dashboard.urls", "dashboard"), namespace="dashboard")),
    path("torob_management/", include(("torob_integration.urls", "torob_management"), namespace="torob_management")),
    ...
    # Sitemap
    # =========================================================
    path("sitemap.xml", storefront_sitemap, {"sitemaps": sitemaps}, name="sitemap"),
]
