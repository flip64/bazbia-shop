    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.TextField(
                blank=True, help_text="یادداشت\u200cهای داخلی مدیر فروشگاه"
            ),
        ),
        migrations.AddField(
            model_name="supplier",
        ...
        migrations.AlterField(
            ...
            name="address",
            field=models.TextField(
                blank=True, help_text="آدرس دفتر یا انبار", null=True
            ),
        ),
        migrations.AlterField(
            model_name="supplier",
        ...
        migrations.AlterField(
            ...
            field=models.EmailField(
                blank=True, help_text="ایمیل", max_length=254, null=True
            ),
        ),
        migrations.AlterField(
            model_name="supplier",
            ...
            field=models.CharField(
                help_text="نام شرکت یا فروشنده عمده", max_length=255, unique=True
            ),
        ),
        migrations.AlterField(
            model_name="supplier",
            name="phone",
            field=models.CharField(
                blank=True, help_text="شماره تماس", max_length=50, null=True
            ),
        ),
        migrations.AlterField(
            model_name="supplier",
            ...
            field=models.URLField(
                blank=True, help_text="آدرس وب\u200cسایت تأمین\u200cکننده", null=True
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "purchase_price",
                    models.DecimalField(
                        decimal_places=0, max_digits=12, verbose_name="قیمت خرید"
                    ),
                ),
                (
                    "supplier_stock",
