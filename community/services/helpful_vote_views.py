...
class ProductReviewHelpfulToggleAPIView(APIView):
    ...
    def post(self, request, review_id):
        ...
        try:
            helpful = HelpfulVoteService.toggle_review_vote(user=request.user, review=review)
...
class ProductAnswerHelpfulToggleAPIView(APIView):
    ...
    def post(self, request, answer_id):
        ...
        try:
            helpful = HelpfulVoteService.toggle_answer_vote(user=request.user, answer=answer)
