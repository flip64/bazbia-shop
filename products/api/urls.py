...
urlpatterns = [
    ...
    path('categories/', views.ProductListCategoryAPIView.as_view, name='list_categories_api'),
    ...
    path('products/categories/<slug:slug>', views.ProductListCategoryAPIView.as_view(), name='category-list-products'),      #   محصولات یک دسته خاص را برمی گرداند  
